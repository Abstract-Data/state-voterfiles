...
class TECRecord(Base):
    ...
    payeeNameFormatted = Column(String, nullable=True)
    ...
    contributorNameFormatted = Column(String, nullable=True)
    contributorCompanyName = Column(String, nullable=True)
    contributorCompanyNameFormatted = Column(String, nullable=True)
