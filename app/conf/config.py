...
class CampaignFinanceConfig:
    STATE: str = 'Texas'
    VALIDATOR: TECRecordValidator = TECRecordValidator
    SQL_MODEL: TECRecord = TECRecord
    ...
    RECORD_TYPE_COLUMN = 'recordType'

    RECORD_CATEGORY_TUPLE: namedtuple = namedtuple('category', ['name', 'records'])
